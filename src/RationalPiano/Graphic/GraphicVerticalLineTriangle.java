 ...
 */
public class GraphicVerticalLineTriangle implements IGraphicVisualizationElement {
	 ...
	 */
	public GraphicVerticalLineTriangle(PApplet papplet, int width, int height, int x_center, int y_top, double bend, int lineColorHueInactive, int lineColorHueActive, int lineColorSaturation, int lineColorBrightness) {
