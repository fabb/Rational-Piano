...
The *documentation* can be found at "doc/RationalPiano.pdf":http://github.com/fabb/Rational-Piano/raw/master/doc/RationalPiano.pdf. It does not always reflect the newest changes, see javadoc for that.
